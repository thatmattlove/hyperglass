...
class _IPv4(CommandSet):
    ...
    traceroute: StrictStr = "tracert -q 2 -f 1 {target}"
...
class _IPv6(CommandSet):
    ...
    traceroute: StrictStr = "tracert ipv6 -q 2 -f 1 {target}"
...
class _VPNIPv4(CommandSet):
    ...
    traceroute: StrictStr = "tracert -q 2 -f 1 -vpn-instance {vrf} {target}"
...
class HuaweiVRPV8Commands(CommandGroup):
