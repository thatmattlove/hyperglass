...
| <R/> `network`      |         | [Device Network Configuration](#network)                                                                           |
...
| :---------------- | :-----: | :------------ | :--------------------------------------------------------------------------------------------------------------- |
| <R/> `name`            | String  |               | Internal name of the device's primary network.                                                              |
| <R/> `display_name`    | String  |               | Display name of the device's primary network.                                                               |
